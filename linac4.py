...
ac.create_particles(N_part, ac.v, ac.v/(1e3), part="ion", acc=ac.linac, C=-1, A=1)
...
plt.savefig(r'/Users/roccobarac/Documents/Bachelors_Thesis_files/linac4-1.png')
plt.close()
...
plt.savefig(r'/Users/roccobarac/Documents/Bachelors_Thesis_files/linac4-2.png')
plt.close()
...
plt.subplots_adjust(top=0.88)
plt.savefig(r'/Users/roccobarac/Documents/Bachelors_Thesis_files/linac4-1_cro.png')
plt.close()
...
plt.subplots_adjust(top=0.88)
plt.savefig(r'/Users/roccobarac/Documents/Bachelors_Thesis_files/linac4-2_cro.png')
plt.close()